...
export default function TanamPage() {
    ...
    const handlePlaceOrder = (amount: string) => {
        console.log("Placing Farm Order:", { amount, order: mockOrder });
        alert(`Order Placed! Tanam ${amount} USDC on BTC.`);
    };
    ...
    return (
        <div className="min-h-screen bg-void-black text-slate-200">
            ...
            <div className="relative z-10 p-4 max-w-md mx-auto min-h-screen flex flex-col">
                ...
                <div className="mb-6">
                    <Link href="/gamified" className="text-[10px] text-slate-500 hover:text-green-400 flex items-center gap-1 mb-4 font-mono transition-colors">
                    ...
                    <div className="flex items-center gap-3 mb-2">
                        ...
                        <div>
                            <h1 className="text-2xl font-bold font-pixel text-green-400">TANAM (FARM)</h1>
                            <p className="text-xs text-slate-400">Harvest yield from calm markets.</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-black border-x-4 border-slate-700 h-6 mb-6 flex items-center overflow-hidden">
                    <Marquee
                        text={`/// MODE: FARM /// YIELD: ${mockOrder.apy} /// STRIKE: $${mockOrder.strike} /// EXPIRY: ${mockOrder.expiry} /// `}
                        speed={20}
                ...
                <div className="flex-1 flex flex-col gap-6">
                    ...
                    <OrderBuilder
                        ...
                        yieldInfo={{
                            ...
                            value: mockOrder.apy,
                            subValue: "Paid in USDC upon expiry"
                        }}
                    />
