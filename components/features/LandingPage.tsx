    ...
    () => import('@/components/3d/FloatingCoin3D').then(mod => mod.FloatingCoin3D),
    {
        ...
        loading: () => (
            <div className="w-full h-64 flex items-center justify-center">
                <div className="text-electric-purple font-pixel text-xs animate-pulse">
                    LOADING 3D...
                </div>
            </div>
        )
        ...
        <div className="flex flex-col gap-0 relative">
            ...
            <section className="min-h-screen relative flex flex-col items-center justify-center p-4 overflow-hidden">
                ...
                >
                    <Suspense fallback={
                        <div className="w-full h-64 flex items-center justify-center">
                            <div className="text-bit-coral font-pixel text-xs animate-pulse">
                                LOADING...
                            </div>
                        </div>
                    }>
                ...
                >
                    <motion.div variants={fadeInUp}>
                        <span className="text-[10px] font-mono text-bit-coral tracking-[0.3em] mb-2 block">
                    ...
                    >
                        <span className="text-bit-green">Trade Options.</span>
                        <br />
                        <span className="text-bit-coral">Play the Market.</span>
                    </motion.h1>
                ...
                >
                    <div className="flex flex-col items-center gap-2">
                        ...
                        <div className="w-px h-8 bg-gradient-to-b from-bit-coral to-transparent animate-pulse"></div>
                    </div>
                </motion.div>
            </section>
            ...
            <motion.section
                ...
                variants={staggerContainer}
                className="py-16 px-4 relative bg-gradient-to-b from-void-black via-bit-coral/10 to-void-black"
            >
                {/* Glitch lines decoration */}
                <div className="absolute inset-0 overflow-hidden pointer-events-none">
                    <div className="absolute top-1/4 left-0 w-full h-px bg-bit-coral/30 animate-glitch"></div>
                    <div className="absolute top-1/2 left-0 w-full h-px bg-bit-coral/20 animate-glitch" style={{ animationDelay: '0.1s' }}></div>
                    <div className="absolute top-3/4 left-0 w-full h-px bg-bit-coral/30 animate-glitch" style={{ animationDelay: '0.2s' }}></div>
                </div>

                <motion.div variants={fadeInUp} className="text-center mb-8">
                    <div className="inline-block bg-bit-coral/20 border-2 border-bit-coral px-4 py-2 mb-4">
                        <span className="font-pixel text-bit-coral text-xs animate-pulse">⚠ SYSTEM ERROR</span>
                    </div>

                    <h2 className="text-2xl font-pixel mb-4">
                        <GlitchText className="text-bit-coral">GAME OVER:</GlitchText>
                        <br />
                ...
                <motion.div
                    variants={scaleIn}
                    className="bg-void-black border-2 border-bit-coral/50 p-6 max-w-md mx-auto relative"
                >
                    {/* Screen crack effect */}
                    <div className="absolute top-2 right-2 text-bit-coral opacity-50">
                    ...
                    <p className="text-slate-300 font-grotesk text-sm leading-relaxed mb-4">
                        DeFi options feel like a <span className="text-bit-coral font-bold">high-stakes cockpit</span> filled
                        with jargon — Delta, Gamma, Theta...
                    </p>

                    <p className="text-slate-400 font-grotesk text-sm leading-relaxed mb-4">
                        It&apos;s lonely, complex, and <span className="text-bit-coral">intimidates newcomers</span>.
                    </p>
                    ...
                    <div className="flex flex-wrap gap-2 mt-4">
                        {['DELTA', 'GAMMA', 'THETA', 'IV', 'STRIKE'].map((term) => (
                            <span
                                key={term}
                                className="text-[8px] font-mono bg-bit-coral/20 text-bit-coral px-2 py-1 border border-bit-coral/30"
                            >
                                {term}?
                            </span>
                        ))}
            ...
            <motion.section
                ...
                variants={staggerContainer}
                className="py-16 px-4 bg-gradient-to-b from-void-black via-bit-coral/5 to-void-black"
            >
                <motion.div variants={fadeInUp} className="text-center mb-8">
                    <div className="inline-block bg-bit-green/20 border-2 border-bit-green px-4 py-2 mb-4">
                        <span className="font-pixel text-bit-green text-xs">★ LEVEL UP ★</span>
                    </div>
                ...
                <div className="space-y-4 max-w-md mx-auto">
                    ...
                    <motion.div variants={scaleIn}>
                        <PowerUpCard
                            ...
                            borderColor="border-bit-coral"
                            glowColor="hover:glow-coral"
                        />
                    </motion.div>
            ...
            >
                <motion.div variants={fadeInUp} className="text-center mb-10">
                    ...
                    <h2 className="text-2xl font-pixel text-white mb-2">
                        CHOOSE YOUR <span className="text-yellow-400">ROLE</span>
                    </h2>
                ...
                <div className="grid gap-6 max-w-md mx-auto">
                    ...
                    <motion.div
                        variants={scaleIn}
                        className="bg-black border-4 border-bit-green p-6 relative overflow-hidden group"
                    >
                        <div className="absolute top-0 right-0 p-2 opacity-20 group-hover:opacity-100 transition-opacity">
                            <Gamepad2 className="w-16 h-16 text-bit-green" />
                        </div>
                    ...
                    <motion.div
                        variants={scaleIn}
                        className="bg-black border-4 border-blue-500 p-6 relative overflow-hidden group"
                    >
                        <div className="absolute top-0 right-0 p-2 opacity-20 group-hover:opacity-100 transition-opacity">
                            <div className="text-6xl text-blue-500 font-pixel">🏦</div>
                        </div>

                        <div className="relative z-10">
                            <h3 className="text-xl font-pixel text-blue-400 mb-1">FARM MODE</h3>
                            ...
                            <ul className="text-xs font-mono text-slate-400 space-y-2 mb-4">
                                ...
                                <li className="flex items-center gap-2">
                                    <span className="text-blue-400">➤</span> Earn automatic yield from premiums.
                                </li>
                            </ul>
            ...
            <motion.section
                ...
                viewport={{ once: true, amount: 0.2 }}
                variants={fadeInUp}
                className="py-16 px-4 bg-gradient-to-b from-void-black to-slate-950"
            >
                <div className="text-center mb-8">
                    <div className="inline-block bg-bit-coral/20 border-2 border-bit-coral px-4 py-2 mb-4">
                        <span className="font-pixel text-bit-coral text-xs">{"<DEV/>"}</span>
                    </div>

                    <h2 className="text-2xl font-pixel text-white mb-2">
                        Developer <span className="text-bit-green">Console</span>
                    </h2>
                    <p className="text-slate-500 font-grotesk text-sm">
            ...
            <motion.footer
                ...
                viewport={{ once: true }}
                variants={fadeInUp}
                className="py-12 px-4 bg-void-black border-t border-slate-800"
            >
                <div className="max-w-md mx-auto text-center">
                    {/* Mission */}
                    <div className="mb-8">
                        <div className="w-12 h-12 mx-auto mb-4 bg-bit-coral/20 border-2 border-bit-coral flex items-center justify-center">
                    ...
                    <div className="flex justify-center gap-4 mb-8">
                        <a
                            ...
                            className="w-10 h-10 bg-slate-900 border border-slate-700 flex items-center justify-center hover:border-bit-green hover:text-bit-green transition-colors"
                        >
                            <Github size={18} />
                        </a>
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="w-10 h-10 bg-slate-900 border border-slate-700 flex items-center justify-center hover:border-bit-coral hover:text-bit-coral transition-colors"
                        >
                            <Twitter size={18} />
                        </a>
                        <a
