            ...
            <AnimatePresence mode="wait">
                {(isTalking || interviewStage !== 'IDLE') && !isDismissed && (
                    <motion.div
                        ...
                        className={`mb-4 mr-4 bg-[#1a1b26] border-2 ${getBorderColor(sentiment)} p-4 rounded-tl-xl rounded-tr-xl rounded-bl-xl max-w-xs relative pointer-events-auto font-pixel text-xs leading-relaxed text-white shadow-lg group`}
                    >
                        {/* Close Button */}
                        <button
                            onClick={(e) => {
